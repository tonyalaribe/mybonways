...
var SignupPage = {
  ...
  validateLogin: () => {
      ...
      if (!SignupPage.LoginUser.User_email || !SignupPage.LoginUser.User_password) {
  ...
  validateSignup: () => {
      if(!SignupPage.SignupUser.full_name || !SignupPage.SignupUser.user_email
      || !SignupPage.SignupUser.user_password) {
      ...
      UserModel.Signup(SignupPage.SignupUser).then(function(){
                    ...
                    <div class={" right-0 buttom-0 absolute bg-white shadow-m2 pa3 br1 w5 "+(vnode.state.showNav?"db":"dn")}>
                        ...
                        <div class="db pv1">
                          ...
                          oninput={m.withAttr("value", function(value) {
                            SignupPage.LoginUser.user_email = value.trim();
                          })}
                          value={SignupPage.LoginUser.user_email}/>
                        </div>
                        <div class="db pv1">
                        ...
                        <div class="db tr">
                          <button class="pv2 ph4 bg-navy bw0 shadow grow white-80 pointer" onclick={function() {
              ...
              <section class="w-100 h-100 bg-black-60 flex flex-column justify-center items-center" >
                <section>
                  <section  class=" pa3 pa2-ns  br2 dib w-100 w-60-ns white-90 ">
                    <div>
                      <h2 class="f2 fw3">Signup to have the best user experience ever.</h2>
                    </div>
                  </section>
                  <section class=" pa3 pa4-ns bg-white br2 dib w-100 w-40-ns ">
                    <div class="">
                      ...
                      <div class="pv2">
                        ...
                        oninput={m.withAttr("value", function(value) {
                          SignupPage.SignupUser.full_name = value.trim();
                        })}
                        value={SignupPage.SignupUser.full_name} />
                      </div>
                      <div class="pv2">
                        <input class="input-reset ba b--black-20 db w-100 pv3 ph3" type="email" placeholder="User Email"
                        oninput={m.withAttr("value", function(value) {
                          SignupPage.SignupUser.user_email = value.trim();
                        })}
                        value={SignupPage.SignupUser.user_email}/>
                      </div>
                      <div class="pv2">
                        <input class="input-reset ba b--black-20 db w-100 pv3 ph3" type="password" placeholder="User Password"
                        oninput={m.withAttr("value", function(value) {
                          SignupPage.SignupUser.user_password = value.trim();
                        })}
                        value={SignupPage.SignupUser.user_password}/>
                      </div>
                      <div class="tr pv2">
                        <button class="pv2 ph4 bg-navy white-90 bw0 shadow-4 grow pointer" onclick={function() {
